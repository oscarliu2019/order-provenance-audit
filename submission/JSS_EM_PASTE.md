...
- 是否有重叠/关联稿件：Yes —— 投往 Information Sciences 的 companion 稿件共用实验
  ...
  经新版 Elsevier 平台正式投出 Information Sciences，稿号 `INS-D-26-12379`
  （2026-09-19 13:07 收到 EM 确认信，平台状态 "Submission Received via Ingest"），
  题名 "Large per-window oracle headroom that three
